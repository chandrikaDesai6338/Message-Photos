 ...
 * {@link SBUTFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SBUTFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SBUTFragment extends Fragment {
     ...
     * @return A new instance of fragment SBUTFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SBUTFragment newInstance(String param1, String param2) {
        SBUTFragment fragment = new SBUTFragment();
    ...
    public void setAdapter(final Response response) {
        ...
        List<Datum> sbutdatumList = new ArrayList<Datum>();
        for (int i = 0; i < response.getData().size(); i++) {
            if (response.getData().get(i).getSocialType().equals("sbut")) {
                sbutdatumList.add(response.getData().get(i));
            }
        }

        MessageAdapter adapter = new MessageAdapter(getContext(), sbutdatumList);
